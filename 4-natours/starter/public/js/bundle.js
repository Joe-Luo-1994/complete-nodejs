...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiajg5MjAyMCIsImEiOiJjazlqYzJjOXUwMGVuM2xxaGZ6ODR0NTAxIn0.C3rEcagAgx1p7lbK4XcPWQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/j892020/ck9jcwgpv0onc1io8b0d9xy4j',
    scrollZoom: false // center: [-118.263768, 34.02792],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Txend map bounds to include current location
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordCurrent, updatePassword, updatePasswordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              updatePasswordConfirm = document.getElementById('password-confirm').value;
              _context.next = 7;
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; //clear input fields
